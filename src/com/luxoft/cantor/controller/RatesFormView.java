...
public class RatesFormView {
    ...
    public String recivingDelateRequestFromRatesForm(@ModelAttribute("currenc") GettingLonelyWalueFromPage currenc,
        ...
        model.addAttribute("currentCode", currencyRepository.getCurrencyByCode(currentCode));
        model.addAttribute("currenc", new GettingLonelyWalueFromPage());
        
        return "forms/menageChosenCurrency";
    }

    @RequestMapping(value = "ofFormOneCurrency", params = "Set as Active", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "ofFormOneCurrency", params = "Add Rate", method = RequestMethod.POST)
    public String recivingAddRequestFromRatesForm(@ModelAttribute("currenc") GettingLonelyWalueFromPage currenc,
            Model model) {
        Dibs processingDibs = currencyRepository.getCurrencyByCode(currentCode);
        processingDibs.setDibsRate(new BigDecimal(currenc.getHermit()));
    ...
    @RequestMapping(value = { "AfterMenageForm",
            "ofFormOneCurrency" }, params = "Main Page", method = RequestMethod.POST)
